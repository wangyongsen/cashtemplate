...
<#list dalgen.xmlMappers as xmlMapper>
 <#-- <@pp.changeOutputFile name = "/main/java/${xmlMapper.doMapper.classPath}/${xmlMapper.doMapper.className}.xml" /> -->
 <@pp.changeOutputFile name = "/main/resources/conf/sqlmap/${xmlMapper.doMapper.className}.xml" />
